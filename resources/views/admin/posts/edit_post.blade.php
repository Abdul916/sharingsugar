                ...
                <div class="ibox-content">
                    <form method="post" id="edit_form" enctype="multipart/form-data">
                        ...
                        <div class="form-group row offset-lg-1">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="keywords" id="keywords" placeholder="SEO Keywords" value="{{$post->keywords}}">
                        ...
                        <div class="form-group row offset-lg-1">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="short_description" placeholder="Short Description" rows="6">{{$post->short_description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row offset-lg-1">
