	...
	<div class="middle-box text-center loginscreen animated fadeInDown">
		<div>
			<div class="col-lg-12 text-center" style="margin-top: 70px;">
				<img class="img-responsive" src="{{ asset('assets/images/logo') }}/{{ get_section_content('project', 'site_logo') }}" alt="logo" style="width: 241px;">
			</div>
			...
			<p class="m-t"> <small>{{ get_section_content('project', 'site_title') }} &copy; {{ date("Y") }}</small> </p>
		</div>
	</div>
